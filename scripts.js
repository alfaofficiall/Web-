...
// Patch CartManager.updateUI untuk juga update sticky & render cart
CartManager.updateUI = (function(orig) {
    return function() {
        ...
        if (typeof renderCartDrawer === 'function') {
            try { renderCartDrawer(); } catch(e) { console.error(e); }
        }
    };
})(CartManager.updateUI);
...
function updateFloatingCart() {
    // Di-disable karena duplikat dengan sticky-order dan menumpuk dengan widget lain
    const floatCart = document.getElementById('float-cart-summary');
